...
$userdb = "sadai";  // MySQL username
$passdb = "sadai";  // MySQL password
$namedb = "tcm";  // MySQL database name
...
$strQuery = "SELECT IFNULL(status,'UNKNOWN') as status, count(Test_case_idpk) as count FROM testcases GROUP by status ORDER BY Test_case_idpk DESC LIMIT 10";
